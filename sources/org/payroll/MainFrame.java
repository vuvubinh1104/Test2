...
public class MainFrame extends JFrame {
	...
	JMenuItem newEmployeeMI, updateEmployeeMI, deleteEmployeeMI, findEmployeeMI;	// employeesMenu
	...
	void initComponents() {
		...
		findEmployeeMI = new JMenuItem("Find Employee");
	...
	void addActionListeners() {
		...
		findEmployeeMI.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	...
	void addComponentsToFrame() {
		...
		employeesMenu.add(findEmployeeMI);
